...
DiscordHTTP::Response DiscordHTTP::makeRequest(http::verb method, const std::string& endpoint, const std::string& body)
{
...
DiscordHTTP::Response DiscordHTTP::modifyGuildMember(const std::string& guildId, const std::string& userId, const std::string& jsonBody)
{
	return makeRequest(http::verb::patch, "/guilds/" + guildId + "/members/" + userId, jsonBody);
}

DiscordHTTP::Response DiscordHTTP::addGuildMemberRole(const std::string& guildId, const std::string& userId, const std::string& roleId)
{
	return makeRequest(http::verb::put, "/guilds/" + guildId + "/members/" + userId + "/roles/" + roleId);
}

DiscordHTTP::Response DiscordHTTP::removeGuildMemberRole(const std::string& guildId, const std::string& userId, const std::string& roleId)
{
	return makeRequest(http::verb::delete_, "/guilds/" + guildId + "/members/" + userId + "/roles/" + roleId);
}

DiscordHTTP::Response DiscordHTTP::removeGuildMember(const std::string& guildId, const std::string& userId)
{
	return makeRequest(http::verb::delete_, "/guilds/" + guildId + "/members/" + userId);
}

DiscordHTTP::Response DiscordHTTP::createGuildMemberBan(const std::string& guildId, const std::string& userId, const std::string& reason)
{
	std::string endpoint = "/guilds/" + guildId + "/bans/" + userId;
	if (!reason.empty())
	{
		endpoint += "?reason=" + DiscordUtils::urlEncode(reason);
	}
	return makeRequest(http::verb::put, endpoint);
}

DiscordHTTP::Response DiscordHTTP::removeGuildMemberBan(const std::string& guildId, const std::string& userId)
{
	return makeRequest(http::verb::delete_, "/guilds/" + guildId + "/bans/" + userId);
}
